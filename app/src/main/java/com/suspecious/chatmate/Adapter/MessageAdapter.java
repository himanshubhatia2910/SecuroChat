package com.suspecious.chatmate.Adapter;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MessageAdapter.ViewHolder holder, int position) {
        ...
        Log.d(TAG, "onBindViewHolder: "+holder.show_message);
        holder.txt_seen.setTypeface(MRR);

        holder.show_message.setText(chat.getMessage());
        Log.d(TAG, "chat.getMessage()one"+chat.getMessage());
    ...
    public int getItemViewType(int position) {
        ...
        if (mChat.get(position).getSender().equals(fuser.getUid())){
            Log.d(TAG, "getItemViewType: "+ MSG_TYPE_RIGHT);
            return MSG_TYPE_RIGHT;
        } else {
            Log.d(TAG, "getItemViewType: "+ MSG_TYPE_LEFT);
