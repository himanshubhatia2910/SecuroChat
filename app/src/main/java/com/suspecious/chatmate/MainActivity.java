...
import com.suspecious.chatmate.Api.OnItemClick;
import com.suspecious.chatmate.Fragment.ChattFragment;
import com.suspecious.chatmate.Fragment.ContactFragment;
import com.suspecious.chatmate.Fragment.ProfileFragment;
...
//        getSupportActionBar().setTitle("");
        ...
        profile_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //viewPager.setAdapter(new UserAdapter(getSupportFragmentManager(), getApplicationContext()));
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (unread == 0){
                    viewPagerAdapter.addFragment(ChattFragment.newInstance(onItemClick), "Chats");
                } else {
                    viewPagerAdapter.addFragment(ChattFragment.newInstance(onItemClick), "("+unread+") Chats");
                }

                viewPagerAdapter.addFragment(ContactFragment.newInstance(onItemClick), "Users");
